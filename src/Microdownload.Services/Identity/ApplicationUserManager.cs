...
namespace Microdownload.Services.Identity
{
        ...
        IApplicationUserManager
    {
        ...
        public async Task<PagedUsersListViewModel> GetPagedUsersListAsync(SearchUsersViewModel model, int pageNumber , bool isadmin)
        {
            ...
            if (isadmin == false)
            {
                query = query.Where(c => c.RegistrarId == cuser.Id);
            }
